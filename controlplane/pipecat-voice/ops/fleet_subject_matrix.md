...
- Skipper NATS enablement is not changed inline. Skipper is a docs/Paperclip owner in the current plan, and enabling an additional live subject owner should be done with an explicit Skipper routing task after Paperclip sync decisions are settled.
