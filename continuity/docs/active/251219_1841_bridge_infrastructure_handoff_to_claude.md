...
```
Location: nats://[redacted-credentials]@localhost:18020
...
```
Location: redis://:[redacted-password]@localhost:18000
...
nc = await nats.connect("nats://[redacted-credentials]@localhost:18020")
```
